 ...
 * Fetches collection data from Supabase and pre-computes all analytics,
 * then delegates interactive rendering to the DashboardContent client island.
 * @source
 */
export default async function DashboardPage() {
  ...
  return (
    <div className="dashboard-container mx-auto max-w-7xl px-6 py-10 lg:px-10">
      {/* ── Welcome header (server-rendered) ── */}
      ...
      {/* ── Quick navigation (server-rendered, no JS needed) ── */}
      ...
      {/* ── Interactive dashboard content (client island) ── */}
      <DashboardContent
        stats={stats}
