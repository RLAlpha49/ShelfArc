...
/** Root container for a tabbed interface. @source */
function Tabs({
  className,
...
/** CVA variant definitions for the tabs list. @source */
...
/** Horizontal or vertical list of tab triggers. @source */
function TabsList({
  className,
  variant = "default",
  ...props
...
/** Individual tab trigger button. @source */
...
/** Content panel associated with a tab trigger. @source */
